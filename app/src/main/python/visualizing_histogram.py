def main():
    ...
    for bounds in file_formation_genes.keys():
        ...
        for way in file_formation_init.keys():
            ...
            with open(f"/data/data/com.example.lab1/files/chaquopy/AssetFinder/app/experiment_results/{file_formation_genes[bounds]}/result_{file_formation_init[way]}.txt", 'r', encoding="UTF-8") as file:
            ...
            plt.savefig(f"/data/data/com.example.lab1/files/chaquopy/AssetFinder/app/histograms/{file_formation_genes[bounds]}/Result_{file_formation_init[way]}")
            if is_create_way == 1:
        ...
        if is_create_way == 1 and bounds != 4:
            ...
            plt.savefig(f"/data/data/com.example.lab1/files/chaquopy/AssetFinder/app/histograms/{file_formation_genes[bounds]}/Result_all")
            ...
            with open(f"/data/data/com.example.lab1/files/chaquopy/AssetFinder/app/experiment_results/{file_formation_genes[bounds]}/all_result.txt", 'w', encoding="utf-8") as f:
            ...
            plt.savefig(f"/data/data/com.example.lab1/files/chaquopy/AssetFinder/app/histograms/{file_formation_genes[bounds]}/result_allmethods_table.png")
            # plt.show()
