def main():
    ...
    for bound in bounds:
        with open(f"/data/data/com.example.lab1/files/chaquopy/AssetFinder/app/experiment_results/{bound}_bound/all_result.txt", 'r', encoding="utf-8") as f:
            data = f.readlines()
            print(data)
    ...
    fig.savefig("/data/data/com.example.lab1/files/chaquopy/AssetFinder/app/all_methods_results")
    fig1.savefig("/data/data/com.example.lab1/files/chaquopy/AssetFinder/app/all_bounds_results")
    plt.show()
