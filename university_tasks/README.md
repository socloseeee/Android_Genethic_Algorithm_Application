...
+ ```apply()``` - так же, как и метод ```commit()```, подтверждает все изменения в настройках,
...
<img alt="img_1.png" height="700" src="img_1.png" width="320"/> <img alt="img_2.png" height="700" src="img_2.png" width="320"/>
...
__Глава 10.__ Потоки, службы и широковещательные приемники

__Глава 11.__ Аппаратные средства смартфона/планшета

__Глава 12.__ Соединение с внешним миром

__Глава 13.__ База данных SQLite

__Глава 14.__ Соэдание анимации
